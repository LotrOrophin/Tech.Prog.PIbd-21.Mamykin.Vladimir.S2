...
{
    public partial class FormPritntingProduct : Form
    {
        [Dependency]
        ...
        public FormPritntingProduct(IPrintingProductLogic service)
        {
            InitializeComponent();
            this.logic = service;
        }
...
MessageBoxIcon.Error);
        ...
        {
            var form = Container.Resolve<FormPrintingProductComponent>();
